...
public class Factura
{
   ...
   private String[] naturezaDespeza;
   ...
   public Factura(int nFiscalEmitente, String emitente, int data, int nFiscalCliente, String descricao, String[] naturezaDespeza, double valorDespeza)
   {
       ...
       if(this.naturezaDespeza.length <= 1)
            this.validada = true;
   ...
   public String[] get_naturezaDespeza(){
       return naturezaDespeza;
   }
   
   public void set_naturezaDespeza(String[] naturezaDespeza){
       this.naturezaDespeza = naturezaDespeza;
   }
   ...
   public double getDeducao(){
       ...
       if(this.naturezaDespeza.length <= 1){      
           ...
           while(i < this.naturezaDespeza.length){
               if(this.naturezaDespeza[i] == "EDUCACAO"){
                   return 1.3;
                }
               if(this.naturezaDespeza[i] == "SAUDE"){
                    return 1.1;
               }
               if(this.naturezaDespeza[i] == "COMUNICACAO"){
                    return 1.7;
               }
               if(this.naturezaDespeza[i] == "ALIMENTACAO"){
                    return 1.2;
               }
               if(this.naturezaDespeza[i] == "ESSENCIAIS"){
                   return 0;
               }
               i++;
           }
   ...
   public void valNatureza(String[] nat){
